...
const MODEL_COLORS: Record<string, string> = {
  ...
  "gpt-image-2": "bg-green-500/10 text-green-400 border-green-500/20",
  ...
  "bg-removal": "bg-emerald-500/10 text-emerald-400 border-emerald-500/20",
  "upscale": "bg-teal-500/10 text-teal-400 border-teal-500/20",
