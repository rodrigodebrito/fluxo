...
const APPS: AppCard[] = [
  ...
  },
  {
    ...
    description: "Converse com um diretor criativo de IA e receba o pacote completo de prompts pra sua campanha",
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
...
export default function AppView() {
  ...
  if (activeApp === "creative-director") {
    return <CreativeDirector onBack={() => setActiveApp(null)} />;
  }
